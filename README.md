...
# Training Curve
The horizontal axis shows number of epochs and the vertial axis shows the win rate (%). Each curve represents an opponent using the old model. Once the win rate reaches 90%, drop the old model and then save the latest for opponent to use.
...
#### Win Rate Change during Epoch 1k - 15k (This period is much tougher and the model converges in 15000 epochs.)
